...
echo "SCOPE: AUTH=$SCOPE_AUTH MIGRATIONS=$SCOPE_MIGRATIONS API=$SCOPE_API FRONTEND=$SCOPE_FRONTEND BACKEND=$SCOPE_BACKEND PERSISTENCE=$SCOPE_PERSISTENCE CONCURRENCY=$SCOPE_CONCURRENCY CICD=$SCOPE_CICD LLM_BOUNDARY=$SCOPE_LLM_BOUNDARY SHELL_EXEC=$SCOPE_SHELL_EXEC CONTRACT=$SCOPE_CONTRACT"
